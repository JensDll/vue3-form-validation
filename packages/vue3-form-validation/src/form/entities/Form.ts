...
export class Form {
  ...
  private trySetKeyedSet = _.trySet(this.keyedSetMap)
  private tryGetKeyedSet = _.tryGet(this.keyedSetMap)
  private tryGetSimple = _.tryGet(this.simpleMap)
  ...
  private static validateFactory(
    ...
    const buffer = new _.LinkedList<boolean>()
